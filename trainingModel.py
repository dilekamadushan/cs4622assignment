...
# -*- coding: utf-8 -*-
"""
Created on Tue May 15 13:19:53 2018
...
SubmissionFormat['total_cases'] = patients_y_pred
SubmissionFormat['total_cases'] = SubmissionFormat['total_cases'].apply(lambda x: int(x) if int(x) >0 else 0)


SubmissionFormat.to_csv('./dengai_predictions_neural_networks.csv',  index = False)
...
#plt.plot(dfFeaturesTest,patients_y_pred['index'])
